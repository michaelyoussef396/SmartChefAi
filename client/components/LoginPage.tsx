...
export function LoginPage() {
  ...
  return (
    <div className="max-w-md w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-6 shadow-lg bg-white/80 backdrop-blur-sm">
      <h2 className="font-bold text-2xl text-neutral-800 mb-2">Log In to SmartChefAI</h2>
      <p className="text-neutral-600 text-sm mb-4">Log in to access your personalized cooking book.</p>
